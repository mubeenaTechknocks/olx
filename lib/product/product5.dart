                    ...
                    children: <Widget>[
                      Stack(children: <Widget>[
                        CarouselSlider(
                          ...
                          items: [
                            "https://apollo-singapore.akamaized.net/v1/files/tfb69ysgfmms-IN/image;s=1080x1080",
                            "https://apollo-singapore.akamaized.net/v1/files/56dtciaoomsu1-IN/image;s=1080x1080",
                          ].map((i) {
                            return Builder(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text("TOMMY HILFIGER Windcheater Hoodie",
                                  style: TextStyle(
                                      color: Color.fromRGBO(0, 48, 52, 1),
                                      letterSpacing: .1,
                                      fontSize: 16,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(top: 5),
                                        child: Text(
                                          "Free shipping all over India (priority kerala)",
                                          style: TextStyle(
                                              color:
                                                  Color.fromRGBO(0, 48, 52, 1),
                                              letterSpacing: .1,
